...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Agu 2024 pada 03.00
...
(18, 'Kecerdasan Emosional', 'Daniel Goleman', 'Gramedia', 1991),
(19, 'Atomic Habits', 'James Clear', 'Gramedia', 2024),
(21, 'Melangkah', 'Js Khairen', 'Gramedia', 2001);
...
(15, 13, 18, '2024-04-29', '2024-05-13', 'Dipinjam'),
(16, 13, 21, '2024-04-29', '2024-05-13', 'Dipinjam');
...
INSERT INTO `user` (`UserID`, `Username`, `Password`, `Email`, `NamaLengkap`, `Alamat`, `Roles`) VALUES
(1, 'San', '123123', 'tio123@gmail', 'Admin', 'Pasuruan', 'Admin'),
(12, 'Petugas', 'Petugas', 'petugas@gmail', 'Tio', 'Bangil', 'petugas'),
(13, 'Udin', '123', 'udinA@gmail.com', 'Udin', 'Mandaran', 'Peminjam'),
(14, 'Rizqi', 'Rizqi', 'Rizqiqi@gmail.com', 'Rizqi aye ayeee', 'Jogja', 'Peminjam'),
(16, 'Nurdian', 'Nurdian', 'Nurdian@gmail.com', 'Nurdian', 'Pasuruan', '');
...
ALTER TABLE `buku`
  ...
  ADD UNIQUE KEY `TahunTerbit` (`TahunTerbit`);
...
ALTER TABLE `kategoribuku_relasi`
  ...
  ADD KEY `BukuID_2` (`BukuID`,`KategoriID`),
...
ALTER TABLE `ulasanbuku`
  ...
  ADD UNIQUE KEY `UserID` (`UserID`,`BukuID`,`Rating`),
  ADD KEY `BukuID` (`BukuID`);
